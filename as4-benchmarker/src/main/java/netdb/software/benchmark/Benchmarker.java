...
import netdb.software.benchmark.rte.tpcc.StoredProcedureRte;
...
public class Benchmarker {
	...
	public Benchmarker() {
		...
		if(TestingParameters.CONNECTION_MODE == TestingParameters.ConnectionMode.STORED_PROCEDURES)
			initDriver();
	}
	...
	private RemoteTerminalEmulator getRte(Object... args) {
		...
		if(TestingParameters.CONNECTION_MODE == TestingParameters.ConnectionMode.JDBC)
			...
			rte = new StoredProcedureRte(args);
